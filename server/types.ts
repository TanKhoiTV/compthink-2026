...
export type ClientToServerEvents = {
	...
	"game:start": (payload: { roomId: string; playerId: PlayerId }) => void;
	...
	"room:leave": (payload: { roomId: string; playerId: PlayerId }) => void;
	...
	"planning:confirm": (payload: { roomId: string; playerId: PlayerId }) => void;
};
