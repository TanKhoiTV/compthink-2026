...
\chapter{Vấn đề cần giải quyết}

\section{Thực trạng thị trường ứng dụng hỗ trợ du lịch}

\begin{itemize}[topsep=0pt, itemsep=2.5pt, leftmargin=1.5cm]
    \item \textbf{Nhóm Giao dịch \& Tiện ích (OTAs \& Navigation)}: Các ứng dụng như Traveloka, Booking.com hay Google Maps giải quyết rất tốt bài toán đơn lẻ như đặt phòng, mua vé,tìm đường từ điểm A đến điểm B.

    \item \textbf{Nhóm Tổng hợp thông tin (Aggregators \& Reviews)}: Các nền tảng như TripAdvisor hay các blog du lịch cung cấp kho dữ liệu khổng lồ về các địa điểm tham quan, quán ăn, và đánh giá của người dùng hoặc tính toán và gợi ý lịch trình cho khách hàng.
\end{itemize}

\section{Khoảng trống của thị trường}
