...
\begin{itemize}[topsep=0pt, itemsep=4pt, leftmargin=1.5cm]
    ...
    \item \texttt{RoomState} — Trạng thái tổng thể của phòng chơi: \texttt{phase} (\texttt{"lobby"}, \texttt{"draft"}, \texttt{"planning"}, \texttt{"simulation"}, \texttt{"gameover"}), \texttt{dayIndex}, \texttt{players} (danh sách người chơi), \texttt{board} (mảng \texttt{GameBoard} cho mỗi người).
