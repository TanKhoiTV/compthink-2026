...
\section{Các Use Cases nên tập trung cho MVP sắp tới}

\begin{itemize}[topsep=0pt, itemsep=2.5pt, leftmargin=1.5cm]
    \item Customer chơi được một màn game lập lịch trình du lịch ảo.
    \item Hệ thống có bộ Thẻ Địa Điểm với tag, vị trí, chi phí tài nguyên và điểm VP.
    \item Người dùng có thể quản lý xu vàng, thể lực và xếp thẻ vào bàn cờ lịch trình.
    \item Hệ thống có thể tính điểm VP dựa trên combo, tài nguyên, khoảng cách và sự kiện.
    \item Sau ván chơi, hệ thống tạo được lịch trình du lịch hoàn chỉnh để tham khảo ngoài đời.
    \item Trạng thái ván chơi, điểm số và lịch trình đầu ra được lưu ổn định.
    \item Content Manager/Moderator chỉnh được dữ liệu thẻ và chỉ số gameplay cơ bản.
    \item Analyst có thể theo dõi dữ liệu playtest để cân bằng game và đánh giá chất lượng lịch trình.
\end{itemize}