...
\begin{itemize}[topsep=0pt, itemsep=2.5pt, leftmargin=1.5cm]
    ...
    \begin{itemize}[label=\ding{111}, leftmargin=1.5cm]
        ...
        \item Tính combo theo ngày (5 nhóm: Theme, Secondary, Tag-pair, Slot/Rhythm, Risk/Reward)
...
\begin{itemize}[topsep=0pt, itemsep=2.5pt, leftmargin=1.5cm]
    ...
    \begin{enumerate}[topsep=0pt, itemsep=2pt]
        ...
        \item Duyệt combo theo từng ngày (cột) để cộng thưởng (src/game/combos.ts): Theme, Secondary, Tag-pair, Slot/Rhythm, Risk/Reward.
