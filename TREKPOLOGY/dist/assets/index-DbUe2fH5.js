...
`)}function Yt(e,t,n){let r=new Blob([t],{type:n}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=e,document.body.appendChild(a),a.click(),a.remove(),URL.revokeObjectURL(i)}function Xt(e){let t=Rt(),n=Lt(`${t.playerName}-phase-${t.phaseNumber}-lich-trinh`);if(e===`json`){Yt(`${n}.json`,JSON.stringify(t,null,2),`application/json;charset=utf-8`);return}Yt(`${n}.txt`,Jt(),`text/plain;charset=utf-8`)}function Zt(){return Ft(this,void 0,void 0,function*(){let e=Jt();try{yield navigator.clipboard.writeText(e),alert(`Đã copy lịch trình vào clipboard.`)}catch{prompt(`Copy lịch trình:`,e)}})}var Qt=function(e,t,n,r){function i(e){return e instanceof n?e:new n(function(t){t(e)})}return new(n||=Promise)(function(n,a){function o(e){try{c(r.next(e))}catch(e){a(e)}}function s(e){try{c(r.throw(e))}catch(e){a(e)}}function c(e){e.done?n(e.value):i(e.value).then(o,s)}c((r=r.apply(e,t||[])).next())})},$t=document.getElementById(`app`),en=7,tn=5,nn=[{id:`p2`,rank:3,name:`Cường`,score:180,coin:890,stamina:20,usedSlots:3},{id:`p1`,rank:1,name:`An`,score:0,coin:3,stamina:2,usedSlots:0,active:!0}],rn=[{id:`p3`,rank:3,name:`Minh`,score:190,coin:720,stamina:15,usedSlots:3},{id:`p4`,rank:3,name:`Khánh`,score:240,coin:720,stamina:15,usedSlots:3}],y={coffee:`https://images.unsplash.com/photo-1517701550927-30cf4ba1f0d5?auto=format&fit=crop&w=1000&q=80`,bridge:`https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1000&q=80`,sea:`https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1000&q=80`,food:`https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=1000&q=80`,market:`https://images.unsplash.com/photo-1563492065599-3520f775eeed?auto=format&fit=crop&w=1000&q=80`,night:`https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&w=1000&q=80`,temple:`https://images.unsplash.com/photo-1528127269322-539801943592?auto=format&fit=crop&w=1000&q=80`};y.coffee,y.bridge,y.sea,y.food,y.night;function an(e){return e.image&&e.image.trim().length>0?e:Object.assign(Object.assign({},e),{image:y.food})}function on(e){for(let t of e){if(!t.image)continue;let e=new Image;e.src=t.image}}function sn(){let e=[];for(let t of O)e.push(...t.pool),e.push(...t.picked);on(e)}function cn(){return dt({cards:ke.map(Le).map(an),fallbackCards:[],handSize:5})}function ln(e){return ft(e)}function un(){let e=pt({deck:w,playerHand:T,shuffleCards:ln});w=e.deck,T=e.playerHand}function dn(){return`Ngày ${Re[S]}`}function fn(){return`Phase ${x}`}function b(){return!!(d.roomId&&d.playerId&&d.roomState)}function pn(){return d.roomState?.phase===`gameover`}function mn(){let e=d.roomState;return e?Gn.map(t=>{let n=e.players[t];return{playerId:t,name:n.name,score:n.score,coin:n.coin,stamina:n.stamina,usedSlots:n.usedSlots,isConnected:n.isConnected}}).sort((e,t)=>t.score===e.score?t.coin===e.coin?t.stamina-e.stamina:t.coin-e.coin:t.score-e.score):[]}function hn(){return d.roomState?.self??null}function gn(){return hn()?.draftPool??null}function _n(){return b()?A&&!$?ys??X:X??gn():null}function vn(e){return(e??[]).map(e=>e.id).join(`,`)}function yn(){let e=gn();X=e?[...e]:null,bs=null}function bn(){return A&&!$}function xn(){_s=null,bs&&=(X=[...bs],null),ys=null,Z=null,Q=null,A=!1,E=!0,k=d.roomState?.self.selectedDraftCardId??null,ps=``,Y(),Rs(),_s=window.setTimeout(()=>{ka()},xs)}function Sn(e,t){if(!($||!D)&&e.length!==0){if(A){t?.length&&(bs=[...t]);return}zs(),ys=[...e],t?.length&&(bs=[...t]),k=null,Q=null,ks=!1,As=!0,E=!1,A=!0,_s=window.setTimeout(()=>{xn()},Ds)}}function Cn(){return hn()?.hand??null}function wn(){return hn()?.selectedDraftCardId??null}function Tn(){return wn()??k}function En(){return!D||Fs()||A||!Z||!b()?!1:Gn.filter(e=>d.roomState?.players[e]?.isConnected).length>1}function Dn(e){return!e||!d.roomState?null:d.roomState.players[e]??null}function On(){return Dn(d.playerId??`p1`)?.name??`Player`}function kn(){return`${fn()} • ${dn()}`.toUpperCase()}function An(){let e=d.playerId;return!e||!d.roomState?null:d.roomState.players[e]??null}function jn(){let e=d.roomState;return e?Gn.map(t=>e.players[t]).filter(e=>e.isConnected):[]}function Mn(){let e=d.roomState;if(!e||e.phase!==`lobby`||d.playerId!==`p1`)return!1;let t=jn();return t.length>0&&t.every(e=>e.isReady)}function Nn(){let e=m();return`
  ...
  `}function Pn(){let e=d.roomState,t=An(),n=d.playerId===`p1`,r=Mn();if(!e||e.phase!==`lobby`)return``;let i=Gn.map(t=>{let n=e.players[t],r=t===d.playerId,i=n.isConnected?`is-connected`:n.hasJoined?`is-offline`:`is-empty`,a=n.isConnected?n.isReady?`READY`:`WAIT`:n.hasJoined?`OFFLINE`:`-`,o=n.isConnected||n.hasJoined?n.name:`Đang chờ...`;return`
  ...
  `}function Fn(e){return Dn(e)?.board??null}function In(){return d.playerId??`p1`}function Ln(e){return!e||!d.roomState?null:d.roomState.players[e]?.score??null}function Rn(){return Ln(d.playerId??`p1`)}function zn(e){let t=hn();return[...X??[],...bs??[],...t?.draftPool??[],...t?.pickedDraftCards??[],...t?.hand??[],...T,...Wn].find(t=>t.id===e)??null}function Bn(e){let t=zn(e.cardId);if(t&&!e.type)return t;if(e.type===`debt`)return Object.assign(Object.assign({},Qr({rowIndex:0,colIndex:0,amount:e.debtAmount??0,sourceCardName:e.sourceCardName??e.name??`Lá đã vay`,lockedReason:e.lockedReason})),{id:e.cardId});if(e.type===`lock`)return Object.assign(Object.assign({},$r({rowIndex:0,colIndex:0,sourceCardName:e.sourceCardName??e.name??`Lá đã vay thể lực`})),{id:e.cardId});let n=e.name??e.cardId,r=e.tag||`food`;return{id:e.cardId,name:n,shortName:n,city:``,shortCity:``,image:e.image??y.food,rarity:`common`,rarityLabel:`★`,vp:e.vp,coin:e.coin??0,stamina:e.stamina??0,tag:r,tagLabel:r,tags:[r.toUpperCase()],icon:e.icon,description:``,bonusText:``}}function Vn(e){let t=Fn(e);return t?t.map(e=>e.map(e=>e?Bn(e):null)):null}function Hn(){let e=d.roomState;if(!e)return;x=e.phaseNumber??x,S=Math.max(0,Math.min(4,e.dayIndex));let t=e.players[d.playerId??`p1`];t&&(Yn=t.score),Wt(),D=e.phase===`draft`,R=e.phase===`simulation`||e.phase===`result`||e.phase===`gameover`,V=e.phase===`result`||e.phase===`gameover`,ar=e.draftRound,nr=e.timer,dr=e.timer,b()&&($i(),xa(),xr());let n=e.self.draftPool??[],r=vn(n),i=X!==null;if(b()){let t=e.phase===`draft`&&ms!==`draft`,a=e.self.pickedDraftCards?.length??0,o=a>Ts,s=e.draftRound>hs;if(t)zs(),Z=null,Q=null,ys=null,yn(),ks=!0,As=!1,E=!0,A=!1,Ms=!1,_s=window.setTimeout(()=>{ka()},xs);else if(e.phase===`draft`&&ms===`draft`&&(o||s)){if(A&&!$)n.length>0&&(bs=[...n]),o&&!ws&&(Z=null,Q=null);else if(!$){let e=X??ys??(n.length>0?[...n]:null);e?.length?Sn(e,n):i||yn()}}else e.phase===`draft`&&!i&&yn();e.phase===`planning`&&ms===`draft`&&X!==null&&X.length>0&&!$&&js===null&&(zs(),$=!0,D=!0,R=!1,A=!0,E=!1,As=!0,ks=!1,js=window.setTimeout(()=>{$=!1,A=!1,X=null,bs=null,js=null,ps=``,Aa()},1550)),e.phase!==`draft`&&!$&&(zs(),X=null,ys=null,bs=null,ks=!1,As=!1,E=!1,A=!1),a>Ts&&!ws&&!A&&(Z=null,Q=null),Ts=a,ms=e.phase,hs=e.draftRound,gs=r}if(b()&&e.phase===`planning`&&ms===`draft`&&!$&&!Ms){Aa();return}if(e.phase===`planning`&&!$){let e=Cn();e&&(T=[...e])}if(e.phase===`draft`&&(T=[],ws||(k=e.self.selectedDraftCardId,e.self.selectedDraftCardId&&!Z&&!Fs()&&(Z=e.self.selectedDraftCardId)),!Fs()&&!ws&&(W(),ma(),oa())),e.phase===`simulation`||e.phase===`result`){if(b()&&!vs){Ra();return}z||(z=Pr(),B=0)}else z=null,B=0,V=!1,vs=!1,$n=!1}function Un(e=S){return Ve(H(),e)}var Wn=cn(),Gn=[`p1`,`p2`,`p3`,`p4`];function Kn(){return{p1:Be(),p2:Be(),p3:Be(),p4:Be()}}function qn(){return{p1:new Set,p2:new Set,p3:new Set,p4:new Set}}function Jn(){if(b()){let e=Vn(In());if(e)return e}return or.p1}var x=1,S=0,Yn=0,Xn={coin:0,stamina:0},C={coin:0,stamina:0},Zn=0,Qn=!1,$n=!1,er=null,tr=null,w=ln(Wn),T=[],E=!1,D=!0,O=[],k=null,nr=10,rr=null,A=!1,ir=null,ar=1,or=Kn(),sr={p1:new Set,p2:new Set,p3:new Set,p4:new Set},cr=null,j=null,M=null,N=null,lr=null,P=null,F=null,I=null,ur=null,L=!1,R=!1,z=null,dr=15,fr=null,B=0,pr=null,V=!1,mr=!1;function H(){return Jn()}function hr(){return Gn.filter(e=>e!==`p1`)}function gr(e,t=S){for(let n=0;n<e.length;n+=1)if(e[n]?.[t]===null)return{rowIndex:n,colIndex:t};for(let t=0;t<e.length;t+=1)for(let n=0;n<e[t].length;n+=1)if(e[t][n]===null)return{rowIndex:t,colIndex:n};return null}function _r(e,t,n){return Object.assign(Object.assign({},e),{id:`${e.id}_${t}_${S}_${n}_${Date.now()}`})}function vr(e){let t=O[{p1:1,p2:0,p3:2,p4:3}[e]]?.picked??[];return t.length>0?t:Wn}function yr(e,t,n){let r=or[e],i=gr(r,S);i&&(r[i.rowIndex][i.colIndex]=_r(t,e,n))}function br(e){let t=0,n=or[e];for(let e=0;e<n.length;e+=1)n[e]?.[S]!==null&&(t+=1);return t}function xr(){cr!==null&&(window.clearInterval(cr),cr=null)}function Sr(){return hr().some(e=>br(e)<3)}function Cr(){if(b()){xr();return}if(D||R||E){xr();return}let e=hr(),t=e.filter(e=>br(e)<3);if(t.length===0){for(let t of e)sr[t].add(S);xr();return}let n=t[Math.floor(Math.random()*t.length)],r=vr(n),i=br(n),a=r[i%Math.max(1,r.length)]??Wn[0];if(!a){xr();return}yr(n,a,i),K()}function wr(){xr(),!b()&&(D||R||E||Sr()&&(cr=window.setInterval(()=>{Cr()},1100)))}function Tr(e){b()||hr().forEach((t,n)=>{br(t)>=3||yr(t,e,n)})}function Er(e){let t=0;for(let n of or[e])for(let e of n)e&&(t+=1);return t}function Dr(e,t){return lr!==null&&lr.rowIndex===e&&lr.colIndex===t}function Or(){return Ye({placedCards:Un(),getBoardDisplayName:Kr})}function kr(){pr!==null&&(window.clearInterval(pr),pr=null)}function Ar(){return!z||z.replaySteps.length===0?null:z.replaySteps[Math.min(B,z.replaySteps.length-1)]}function jr(e){if(!e)return!1;let t=e;return t.isBadEvent===!0||t.isNegativeEvent===!0||t.eventType===`traffic`||t.eventType===`storm`||t.eventType===`distance`}function Mr(e){return e?.eventType?e.eventType===`promo`?`eventPromo`:e.eventType===`traffic`?`eventTraffic`:e.eventType===`storm`?`eventStorm`:e.eventType===`distance`?`eventDistance`:null:null}function Nr(){let e=Ar();e&&v(Mr(e)??(jr(e)?`scanBad`:`scanCell`))}function Pr(){return tt({boardSlots:H(),currentDayIndex:S,dayLabel:dn(),rows:ze,getBoardDisplayName:Kr,getCardTagKeys:Ue,countCardsWithTag:We,getCurrentDayPlacedCards:Un})}function Fr(){return z?{baseVP:z.baseVP,bonusVP:z.bonusVP,totalVP:z.finalVP,spentCoin:z.spentCoin,spentStamina:z.spentStamina+Fa(z),usedSlots:z.usedSlots,lines:z.lines}:Or()}function Ir(){let e=z?Fr():Or();return{vp:Yn,coin:e.spentCoin,stamina:e.spentStamina,usedSlots:e.usedSlots}}function Lr(){let e=Ir();return nn.map(t=>{if(!t.active)return Object.assign(Object.assign({},t),{usedSlots:t.id?Er(t.id):t.usedSlots});let n=Rr();return Object.assign(Object.assign({},t),{score:e.vp,coin:Math.max(0,n.coin),stamina:Math.max(0,n.stamina),usedSlots:e.usedSlots})})}function Rr(){if(b()){let e=An();if(e)return{coin:e.coin,stamina:e.stamina}}let e=mt({totals:Ir(),startingCoin:3,startingStamina:2});return{coin:e.coin+Xn.coin+C.coin,stamina:e.stamina+Xn.stamina+C.stamina}}function zr(e){return ht({card:e,remaining:Rr()})}function Br(e){return gt(zr(e))}function Vr(e,t,n,r){let i=e.trim().length;return i>=r?`${t} ${t}--xs`:i>=n?`${t} ${t}--sm`:t}function Hr(e){return Vr(e,`hand-card__name`,16,23)}function Ur(e){return Vr(e,`hand-card__city`,18,28)}function Wr(e){return Vr(e,`board-mini__name`,12,18)}function Gr(e){return Vr(e,`board-mini__city`,12,21)}function Kr(e){return e.shortName?.trim()||e.name}function qr(e){return e.shortCity?.trim()||e.city}function Jr(e){return e?.boardTokenType??null}function Yr(e){return Jr(e)===`debt`}function Xr(e){return Jr(e)===`lock`}function Zr(e,t){return(H()[e]?.[t]??null)===null}function Qr(e){return{id:`debt_token_${e.rowIndex}_${e.colIndex}_${Date.now()}`,name:e.lockedReason?`Nợ + Kiệt sức`:`Token Nợ`,shortName:e.lockedReason?`Nợ + Kiệt sức`:`Token Nợ`,city:`Trả ${e.amount} xu`,shortCity:`Trả ${e.amount} xu`,image:y.food,rarity:`common`,rarityLabel:`!`,vp:0,coin:0,stamina:0,tag:`utility`,tagLabel:`Nợ`,tags:[`UTILITY`],icon:`💸`,description:`Bấm để trả ${e.amount} xu. Nếu không trả trước khi hết ngày sẽ bị -20 VP.`,bonusText:`Không trả nợ: -20 VP`,boardTokenType:`debt`,debtAmount:e.amount,lockedReason:e.lockedReason,sourceCardName:e.sourceCardName}}function $r(e){return{id:`exhaust_lock_${e.rowIndex}_${e.colIndex}_${Date.now()}`,name:`Bị khóa`,shortName:`Bị khóa`,city:`Kiệt sức`,shortCity:`Kiệt sức`,image:y.food,rarity:`common`,rarityLabel:`!`,vp:0,coin:0,stamina:0,tag:`utility`,tagLabel:`Khóa`,tags:[`UTILITY`],icon:`🔒`,description:`Ô này bị khóa vì đã vay thể lực ở ${e.sourceCardName}.`,bonusText:`Không thể xếp bài vào ô này.`,boardTokenType:`lock`,lockedReason:`Kiệt sức`,sourceCardName:e.sourceCardName}}function ei(e,t){return e<ze.length-1?{rowIndex:e+1,colIndex:t}:t<4?{rowIndex:0,colIndex:t+1}:null}function ti(e){if(e.coinDebt>0&&(Zn+=e.coinDebt),e.staminaDebt<=0)return;let t=ei(e.rowIndex,e.colIndex);t&&H()[t.rowIndex]?.[t.colIndex]===null&&(H()[t.rowIndex][t.colIndex]=$r({rowIndex:t.rowIndex,colIndex:t.colIndex,sourceCardName:e.card.name}))}function ni(e,t,n){let r=n.debtAmount??0,i=Rr();if(!(r<=0)){if(i.coin<r){alert(`Không đủ xu để trả nợ. Cần ${r} xu.`);return}C=Object.assign(Object.assign({},C),{coin:C.coin-r}),H()[e][t]=null,v(`eventPromo`),K()}}function ri(e,t,n){if(t!==S){F=n,I={rowIndex:e,colIndex:t},K();return}if(b()){ue({rowIndex:e,colIndex:t});return}ni(e,t,n)}function ii(e,t,n){let r=ei(e,t);if(!r)return;let i=H()[r.rowIndex]?.[r.colIndex]??null;i&&i.boardTokenType===`lock`&&i.sourceCardName===n.name&&(H()[r.rowIndex][r.colIndex]=null)}function ai(e){return Vr(e,`focused-card__name`,18,25)}function oi(e){return Vr(e,`focused-card__city`,18,28)}function si(e){if(!e)return null;if(b()){let t=gn()?.find(t=>t.id===e)??null;if(t)return t;let n=Cn()?.find(t=>t.id===e)??null;if(n)return n}if(D){let t=U()?.pool.find(t=>t.id===e)??null;if(t)return t}return T.find(t=>t.id===e)??null}function ci(e,t){return He(H(),e,t)}function li(e){let t=Un(),n=Ue(e);return n.includes(`FOOD`)&&We(t,`FOOD`)>=2||n.includes(`CULTURE`)&&We(t,`CULTURE`)>=2||n.includes(`ACTION`)&&We(t,`ACTION`)>=2?!0:e.onPlayEffect?.has_effect===!0&&e.onPlayEffect.effect_type===`GAIN_VP`}function ui(e,t){let n=Kr(e),r=qr(e),i=Wr(n);Gr(r);let a=li(e),o=e;if(o.boardTokenType===`debt`)return`
      <article
  ...
  `}function di(e,t,n=!1){let r=D&&!n&&e.id===Z,i=!D&&e.id===j,a=r||i,o=zr(e).canAfford?Br(e):`Thiếu tài nguyên: đặt lá này sẽ tạo nợ / kiệt sức.`;return`
    <article
      ...
      title="${o}"
      onpointerdown="${D?``:`event.stopPropagation(); startHandPointerDrag(event, '${e.id}')`}"
      onclick="${D?``:`event.stopPropagation(); window['selectHandCard']('${e.id}')`}"
    >
      ${i?`<button
      ...
      <div class="hand-card__header">
        <div class="hand-card__title-block">
          <h3 class="${Hr(e.name)}">${e.name}</h3>
          <div class="${Ur(e.city)}">📍 ${e.city}</div>
        </div>
  ...
  `}function fi(e){let t=ai(e.name),n=oi(e.city);return`
  ...
  `}function pi(){let e=U()?.pool??[],t=ta();return`
    <div class="draft-hand-meta">
      <div class="draft-hand-meta__info">
        <span>Vòng ${ar}/5</span>
        <strong>${t?Kr(t):`Bấm 1 lá để chọn`}</strong>
        <em>
          ${E?`Đang phát bài vào tay...`:A?`Đang chuyền bài còn lại vào lượt kế tiếp...`:t?`Đã chọn. Hết giờ mới chuyền bài.`:e.length>0?`Bấm để chọn, giữ 0.5s để xem lớn.`:`Đang chuẩn bị bài...`}
        </em>
      </div>
  ...
  `}function mi(){return b()?hn()?.pickedDraftCards?.length??0:U()?.picked?.length??0}function hi(){return b()?hn()?.pickedDraftCards??[]:U()?.picked??[]}function gi(e){return(b()?_n()??[]:U()?.pool??[]).find(t=>t.id===e)??null}function _i(){let e=hi(),t=Z;if(!t||e.some(e=>e.id===t))return e;let n=gi(t);return n?[...e,n]:e}function vi(){return _i().length}var yi={1:[{rotate:0,ty:-6}],2:[{rotate:-16,ty:-4},{rotate:16,ty:-4}],3:[{rotate:-18,ty:-5},{rotate:0,ty:-10},{rotate:18,ty:-5}],4:[{rotate:-20,ty:-3},{rotate:-8,ty:-8},{rotate:8,ty:-8},{rotate:20,ty:-3}],5:[{rotate:-18,ty:-2},{rotate:-9,ty:-7},{rotate:0,ty:-11},{rotate:9,ty:-7},{rotate:18,ty:-2}]};function bi(){let e=document.documentElement,t=parseFloat(getComputedStyle(e).getPropertyValue(`--hand-card-w`))||158,n=parseFloat(getComputedStyle(e).getPropertyValue(`--hand-card-h`))||218;return{handCardW:t,handCardH:n,cardW:t*.84,cardH:n*.84,stepX:t*.46}}function xi(e,t){return yi[e]?.[t-1]??{rotate:0,ty:0}}function Si(e,t){let n=document.querySelector(`.player-hand__cards--draft`);if(!n||e<1||t<1||t>e)return null;let r=xi(e,t),{cardW:i,cardH:a,stepX:o}=bi(),s=n.getBoundingClientRect(),c=i+(e-1)*o,l=s.left+(s.width-c)/2+(t-1)*o,u=s.bottom-a-4+r.ty;return new DOMRect(l,u,i,a)}function Ci(e){let t=e.className.match(/hand-card--picked-slot-(\d)/),n=e.closest(`[class*='picked-count-']`)?.className.match(/picked-count-(\d)/);return!t||!n?null:{count:parseInt(n[1],10),slotIndex:parseInt(t[1],10)}}function wi(){let e=vi(),t=e,n=Si(e,t);return n?{rect:n,rotate:xi(e,t).rotate}:null}function Ti(e){let t=Ci(e);if(!t)return null;let n=Si(t.count,t.slotIndex);return n?{rect:n,rotate:xi(t.count,t.slotIndex).rotate}:null}function Ei(e){return document.querySelector(`.draft-center-card[data-draft-card-id="${e}"]`)?.closest(`.draft-center-card-wrapper`)??null}function Di(e){var t;Z=null,k===e&&(k=null),(t=Ei(e))==null||t.classList.remove(`draft-center-card-wrapper--flown-to-hand`),ma(),W(),Mi()}function Oi(e,t,n){let r=n?.isPending?` hand-card--picked-pending`:``,i=n?.hiddenForMeasure?` hand-card--picked-pending-hidden`:``;return`
    <article
  ...
  `}function ki(e){let t=new Set(hi().map(e=>e.id));return _i().map((n,r)=>Oi(n,r,{isPending:n.id===Z&&!t.has(n.id),hiddenForMeasure:e?.hiddenPendingMeasure&&n.id===Z})).join(``)}function Ai(){return!D||$?!1:bn()&&(ys??X)?.length||A&&ir?.length?!0:!(mi()>=tn)}function ji(){return b()?bn()?ys??X??[]:_n()??[]:A&&ir?ir:U()?.pool??[]}function Mi(){let e=document.querySelector(`.deck-pile-panel__draft-confirm`);e&&(e.disabled=!((Z||k)&&!ws&&!A&&!Fs()))}function Ni(){return $&&A}function Pi(){let e=_n()??[],t=new Set((hn()?.pickedDraftCards??[]).map(e=>e.id));return e.filter(e=>!t.has(e.id))}function Fi(){let e=d.roomState?.draftTimerHold??0;return Ss||E||A||e>0||Date.now()<Cs}function Ii(){return Fi()?`Chia bài`:`${nr}s`}function Li(){return!Fi()&&nr<=3}function Ri(){if(!D||!Ai())return``;let e=ji();if(e.length===0)return`
      <div class="draft-center-overlay">
        <p style="color:#fff5d1; font-size:1.2rem;">Đang chuẩn bị bài...</p>
      </div>
    `;let t=e.slice(0,4),n=e.slice(4),r=(e,t)=>e.map((e,n)=>{let r=t+n,i=t+n+1,a=la(e.id),o=A?``:`
      ...
      `}).join(``);return`
    <div class="draft-center-overlay ${A&&!$?`draft-center-overlay--passing`:``}">
      ...
      ${En()?`<div class="draft-center-wait-banner">Đang chờ đối thủ...</div>`:``}
    </div>
  `}function zi(){return Ni()?`
  ...
  `:``}function Bi(e){return(O[{p1:1,p2:0,p3:2,p4:3}[e]]?.picked??[]).map(e=>e.icon)}function Vi(e){return!!(e&&e!==`p1`&&D)}function Hi(e){let t=Fn(e);if(!t)return Array.from({length:25}).map(()=>`<div class="opponent-cell">+</div>`).join(``);let n=[];for(let e of t)for(let t of e){if(!t){n.push(`<div class="opponent-cell">+</div>`);continue}n.push(`
        <div
      ...
      `)}return n.join(``)}function Ui(e){if(!e)return Array.from({length:25}).map(()=>`<div class="opponent-cell">+</div>`).join(``);if(d.roomState)return Hi(e);let t=or[e],n=Vi(e)?Bi(e):[],r=[],i=0;for(let e of t)for(let t of e){let e=n[i]??``;if(!t){r.push(`
          <div
      ...
      `),i+=1}return r.join(``)}function Wi(e){let t=Dn(e.id),n=t?Object.assign(Object.assign({},e),{name:t.name,score:t.score,coin:t.coin,stamina:t.stamina,usedSlots:t.usedSlots}):e,r=t?.isConnected===!1?` side-player--offline`:``;return`
  ...
  `}function U(){return Ke(O,Ge())}function Gi(){return!b()}function Ki(e){let t=String(e.id??e.card_id??``).toUpperCase();if(t.includes(`_CULT_`)||t.startsWith(`SG_CULT`))return`CULTURE`;if(t.includes(`_ACT_`)||t.startsWith(`SG_ACT`))return`ACTION`;if(t.includes(`_UTIL_`)||t.startsWith(`SG_UTIL`))return`UTILITY`;if(t.includes(`_FOOD_`)||t.startsWith(`SG_FOOD`))return`FOOD`;let n=(e.tags??[]).map(e=>String(e).toUpperCase());if(n.includes(`CULTURE`))return`CULTURE`;if(n.includes(`ACTION`))return`ACTION`;if(n.includes(`UTILITY`))return`UTILITY`;if(n.includes(`FOOD`))return`FOOD`;let r=String(e.tag??``).toUpperCase();return r===`CULTURE`?`CULTURE`:r===`ACTION`?`ACTION`:r===`UTILITY`?`UTILITY`:r===`FOOD`?`FOOD`:`UNKNOWN`}function qi(e){let t=[...e];for(let e=t.length-1;e>0;--e){let n=Math.floor(Math.random()*(e+1)),r=t[e];t[e]=t[n],t[n]=r}return t}function Ji(e){return e.reduce((e,t)=>{let n=Ki(t);return e[n]=(e[n]??0)+1,e},{})}function Yi(e,t,n,r,i){if(n.length>=i)return;let a=e.get(t);if(!a||a.length===0)return;let o=a.shift();!o||r.has(o.id)||(n.push(o),r.add(o.id))}function Xi(e){let t=[`FOOD`,`CULTURE`,`ACTION`,`UTILITY`,`FOOD`,`CULTURE`,`ACTION`];if(e<=t.length)return qi(t.slice(0,e));let n=[...t],r=[`FOOD`,`CULTURE`,`ACTION`,`UTILITY`];for(;n.length<e;)n.push(r[n.length%r.length]);return qi(n)}function Zi(e){if(e<=0||w.length===0)return[];let t=ln(w),n=new Map;for(let e of t){let t=Ki(e),r=n.get(t)??[];r.push(e),n.set(t,r)}for(let[e,t]of n.entries())n.set(e,qi(t));let r=[],i=new Set,a=Xi(e);for(let t of a)Yi(n,t,r,i,e);let o=qi([`CULTURE`,`ACTION`,`UTILITY`,`FOOD`,`UNKNOWN`]);for(;r.length<e;){let t=!1;for(let a of o){let o=r.length;if(Yi(n,a,r,i,e),r.length>o&&(t=!0),r.length>=e)break}if(!t)break}return w=t.filter(e=>!i.has(e.id)),console.log(`[Draft] deck tag counts before draw:`,Ji(t)),console.log(`[Draft] single-player pool:`,r.map(e=>`${e.id}:${Ki(e)}`)),console.log(`[Draft] single-player pool tag counts:`,Ji(r)),r}function Qi(){if(!Gi())return;let e=Ge(),t=U();if(!t)return;t.pool.length>0&&(w=ln([...w,...t.pool]));let n=Zi(en);O=O.map((t,r)=>r===e?Object.assign(Object.assign({},t),{pool:n}):t)}function $i(){rr!==null&&(window.clearInterval(rr),rr=null)}function ea(){$i(),!b()&&(!D||A||(rr=window.setInterval(()=>{if(--nr,nr<=0){nr=0,aa();return}K()},1e3)))}function ta(){if(b()){let e=_n(),t=Tn();return!e||!t?null:e.find(e=>e.id===t)??null}let e=U();return!e||!k?null:e.pool.find(e=>e.id===k)??null}function na(){O=Je(O)}function ra(){$i(),wa();let e=U(),t=O.reduce((e,t)=>(e.push(...t.pool),e),[]);t.length>0&&(w=ln([...w,...t])),T=e?e.picked.slice(0,tn):[],D=!1,A=!1,k=null,nr=0,E=!0,K(),Ma()}function ia(e){if(!D||A)return;let t=Ge(),n=[];if(Gi()){let r=U();if(!r||r.pool.length===0){ra();return}let i=r.pool.find(t=>t.id===e)??qe(r.pool);if(!i){ra();return}n.push({playerIndex:t,pickedCard:i}),ir=[...r.pool],O=O.map((e,n)=>n===t?Object.assign(Object.assign({},e),{picked:[...e.picked,i],pool:e.pool.filter(e=>e.id!==i.id)}):e),k=null,Z=null,Q=null,A=!0,$i(),K(),Ea(),window.setTimeout(()=>{ir=null;let e=U();if(!e||e.picked.length>=tn){A=!1,ra();return}Qi(),sn(),ar+=1,nr=10,A=!1,ja()},Ds);return}let r=U();ir=r?[...r.pool]:null,O=O.map((r,i)=>{if(r.pool.length===0)return r;let a=i===t?r.pool.find(t=>t.id===e)??qe(r.pool):qe(r.pool);return a?(n.push({playerIndex:i,pickedCard:a}),Object.assign(Object.assign({},r),{picked:[...r.picked,a],pool:r.pool.filter(e=>e.id!==a.id)})):r}),k=null,Z=null,Q=null,A=!0,$i(),K(),Ea(),window.setTimeout(()=>{ir=null;let e=U();if(!e||e.picked.length>=tn){A=!1,ra();return}na(),sn(),ar+=1,nr=10,A=!1,ja()},Ds)}function aa(){let e=U();if(!e||e.picked.length>=tn){ra();return}ia(k??null)}function oa(){ma();let e=ta(),t=document.querySelector(`.draft-hand-meta__info strong`);t&&(t.textContent=e?Kr(e):`Bấm 1 lá để chọn`);let n=document.querySelector(`.draft-hand-meta__info em`);n&&(n.textContent=e?`Đã chọn. Bấm lại lá đó để hủy chọn.`:`Bấm để chọn, giữ 0.5s để xem lớn.`);let r=document.querySelector(`.draft-center-wait-banner`);r&&(r.style.display=En()?``:`none`),Mi()}function sa(){let e=document.querySelector(`.draft-pick-fly-layer`);return e||(e=document.createElement(`div`),e.className=`draft-pick-fly-layer`,document.body.appendChild(e)),e}function ca(e){return Math.max(.85,Math.min(1.2,e))}function la(e){return Fs()?e===Z||e===Q:e===Z||e===Q?!0:A||$?hi().some(t=>t.id===e):!1}function ua(e,t,n,r,i){let a=sa(),{cardW:o,cardH:s}=bi(),c=i?.flyWidth??o,l=i?.flyHeight??s,u=e.left+e.width/2,d=e.top+e.height/2,f=t.left+t.width/2,p=t.top+t.height/2,m=i?.scaleStart??1,ee=i?.rotateStart??0,h=i?.rotateEnd??0,g=document.createElement(`div`);return g.className=`draft-pick-fly-card`,i?.direction===`to-pool`&&g.classList.add(`draft-pick-fly-card--to-pool`),g.style.left=`${u-c/2}px`,g.style.top=`${d-l/2}px`,g.style.width=`${c}px`,g.style.height=`${l}px`,g.style.setProperty(`--fly-dx`,`${f-u}px`),g.style.setProperty(`--fly-dy`,`${p-d}px`),g.style.setProperty(`--fly-scale-start`,String(m)),g.style.setProperty(`--fly-scale-end`,String(r)),g.style.setProperty(`--fly-rotate-start`,`${ee}deg`),g.style.setProperty(`--fly-rotate-end`,`${h}deg`),g.innerHTML=n,a.appendChild(g),g.offsetHeight,g.classList.add(`draft-pick-fly-card--animating`),new Promise(e=>{let t=!1,n=()=>{t||(t=!0,g.remove(),a.childElementCount===0&&a.remove(),e())};g.addEventListener(`animationend`,n,{once:!0}),window.setTimeout(n,Es+100)})}function da(e){return Qt(this,void 0,void 0,function*(){if(!gi(e)){Di(e);return}let t=Ei(e),n=t?.querySelector(`.hand-card`),r=n?.getBoundingClientRect(),i=n?.outerHTML;if(!r||!i||!n||!t||r.width<=0||r.height<=0){Di(e);return}Z=e,t.classList.add(`draft-center-card-wrapper--flown-to-hand`),ma(),W({hiddenPendingMeasure:!0}),yield new Promise(e=>{window.requestAnimationFrame(()=>window.requestAnimationFrame(()=>e()))});let a=wi();if(!a){Di(e);return}let o=ca(r.width/bi().cardW);yield ua(r,a.rect,i,Os,{direction:`to-hand`,scaleStart:o,rotateStart:0,rotateEnd:a.rotate,flyWidth:bi().cardW,flyHeight:bi().cardH}),W()})}function fa(e){return Qt(this,void 0,void 0,function*(){let t=document.querySelector(`[data-draft-hand-card-id="${e}"]`),n=t?.outerHTML,r=t?Ti(t):null,i=r?.rect??t?.getBoundingClientRect();if(!i||!n||!t||i.width<=0||i.height<=0)return;t.classList.add(`hand-card--picked-pending-hidden`),Q=e,ma();let a=Ei(e),o=(a?.querySelector(`.hand-card`))?.getBoundingClientRect()??a?.getBoundingClientRect();if(!o){Z=null,Q=null,W(),ma();return}let{cardW:s,cardH:c}=bi(),l=ca(o.width/s);try{yield ua(i,o,n,l,{direction:`to-pool`,scaleStart:Os,rotateStart:r?.rotate??0,rotateEnd:0,flyWidth:s,flyHeight:c})}finally{Z=null,Q=null,W(),ma()}})}function pa(e,t){return Qt(this,void 0,void 0,function*(){let n=document.querySelector(`[data-draft-hand-card-id="${e}"]`),r=n?Ti(n):null,i=r?.rect??n?.getBoundingClientRect(),a=n?.outerHTML,o=Ei(t)?.querySelector(`.hand-card`),s=o?.getBoundingClientRect(),c=o?.outerHTML,l=Ei(e)?.querySelector(`.hand-card`),u=l?.getBoundingClientRect(),d=l?.outerHTML;if(!i||!a||!s||!c||!u||!d||!n||i.width<=0||s.width<=0||u.width<=0)return;n.classList.add(`hand-card--picked-pending-hidden`),Z=t,Q=e,ma(),W({hiddenPendingMeasure:!0}),yield new Promise(e=>{window.requestAnimationFrame(()=>window.requestAnimationFrame(()=>e()))});let f=wi();if(!f){n.classList.remove(`hand-card--picked-pending-hidden`),Z=e,Q=null,ma(),W();return}let{cardW:p,cardH:m}=bi(),ee=ca(u.width/p),h=ca(s.width/p);try{yield Promise.all([ua(i,u,a,ee,{direction:`to-pool`,scaleStart:Os,rotateStart:r?.rotate??0,rotateEnd:0,flyWidth:p,flyHeight:m}),ua(s,f.rect,c,Os,{scaleStart:h,rotateStart:0,rotateEnd:f.rotate,flyWidth:p,flyHeight:m})])}finally{Q=null,W(),ma()}})}function W(e){let t=document.querySelector(`.player-hand__cards--draft`);t&&(t.className=`player-hand__cards player-hand__cards--draft player-hand__cards--picked player-hand__cards--picked-count-${vi()}`,t.innerHTML=ki(e))}function ma(){document.querySelectorAll(`.draft-center-card-wrapper`).forEach(e=>{let t=e.querySelector(`.draft-center-card[data-draft-card-id]`),n=t?.dataset.draftCardId;if(!n)return;e.classList.remove(`draft-center-card-wrapper--selected`),e.classList.toggle(`draft-center-card-wrapper--flown-to-hand`,la(n)),t.style.removeProperty(`z-index`),t.style.removeProperty(`isolation`);let r=t.querySelector(`.hand-card`);r?.classList.remove(`hand-card--draft-selected`),r?.style.removeProperty(`z-index`),r?.style.removeProperty(`position`);let i=e.querySelector(`.draft-center-btn`);i&&(i.textContent=`CHỌN`,i.classList.remove(`daily-draft-card--selected`),i.style.removeProperty(`z-index`),i.style.removeProperty(`isolation`))})}function ha(e,t,n){return Qt(this,void 0,void 0,function*(){ws=!0;let r=!1;try{t?e?e!==t&&(yield pa(e,t),r=Z===t):(yield da(t),r=Z===t):e&&(yield fa(e),r=!0),r&&W(),oa(),b()&&oe(n)}finally{ws=!1,Mi()}})}function ga(e){if(!D||ws||A||Fs()||L&&(L=!1,P||F||I))return;let t=Z,n=k===e?null:e;v(`cardSelect`),k=n,P=null,F=null,I=null,n&&!t&&(Z=n,ma(),W({hiddenPendingMeasure:!0}),Mi()),ha(t,n,e)}function _a(){if(!D||ws||A||!(Z||k))return;let e=k??Z;if(e){if(b()){let e=ys??X??gn();e?.length&&!A&&!$&&(Sn(e,null),Y(),As=!1,Ea()),se();return}ia(e)}}function va(e){if(!(D||R||E)){if(L){L=!1;return}v(`cardSelect`),j=j===e?null:e,M=null,P=null,F=null,I=null,Y()}}function ya(){D||(j=null,M=null,P=null,F=null,I=null,K())}function ba(e){let t=Math.max(0,e),n=Math.floor(t/60),r=t%60;return`${n}:${r<10?`0${r}`:`${r}`}`}function xa(){fr!==null&&(window.clearInterval(fr),fr=null)}function Sa(){xa(),!b()&&(R||D||(fr=window.setInterval(()=>{if(--dr,dr<=0){dr=0,xa(),La();return}K()},1e3)))}function Ca(){er!==null&&(window.clearTimeout(er),er=null)}function wa(){tr!==null&&(window.clearTimeout(tr),tr=null)}function Ta(e,t,n,r,i){e.forEach((a,o)=>{let s=a.getBoundingClientRect(),c=s.left+s.width*.5,l=s.top+s.height*.5,u=o-(e.length-1)/2,d=t-c+u*5,f=n-l+Math.abs(u)*3,p=r-c+u*2,m=i-l+u*2,ee=d+(p-d)*.34,h=Math.min(f,m)-150-Math.abs(u)*7,g=d+(p-d)*.72,te=Math.min(f,m)-185-Math.abs(u)*5;a.style.setProperty(`--gather-x`,`${d}px`),a.style.setProperty(`--gather-y`,`${f}px`),a.style.setProperty(`--gather-r`,`${u*4}deg`),a.style.setProperty(`--arc1-x`,`${ee}px`),a.style.setProperty(`--arc1-y`,`${h}px`),a.style.setProperty(`--arc2-x`,`${g}px`),a.style.setProperty(`--arc2-y`,`${te}px`),a.style.setProperty(`--deck-in-x`,`${p}px`),a.style.setProperty(`--deck-in-y`,`${m}px`),a.style.setProperty(`--deck-r`,`${-6+u*3}deg`)})}function Ea(){v(`returnDeck`),window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{var e;let t=document.querySelector(`.draft-center-overlay--passing:not(.draft-center-overlay--returning)`)??document.querySelector(`.draft-center-overlay:not(.draft-center-overlay--returning)`),n=document.querySelector(`.deck-card-stack`);if(!t||!n)return;let r=Array.from(t.querySelectorAll(`.draft-center-card-wrapper:not(.draft-center-card-wrapper--flown-to-hand)`));if(r.length===0)return;t.classList.add(`draft-center-overlay--passing`);let i=t.getBoundingClientRect(),a=n.getBoundingClientRect();Ta(r,i.left+i.width*.5,i.top+i.height*.38,a.left+a.width*.34,a.top+a.height*.54),(e=n.closest(`.deck-pile-panel`))==null||e.classList.add(`deck-receiving`),t.classList.add(`pass-active`)})})}function Da(){v(`returnDeck`),window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{var e;let t=document.querySelector(`.draft-center-overlay--returning`),n=document.querySelector(`.deck-card-stack`);if(!t||!n)return;let r=Array.from(t.querySelectorAll(`.draft-center-card-wrapper--return`)),i=t.getBoundingClientRect(),a=n.getBoundingClientRect();Ta(r,i.left+i.width*.5,i.top+i.height*.38,a.left+a.width*.34,a.top+a.height*.54),(e=n.closest(`.deck-pile-panel`))==null||e.classList.add(`deck-receiving`),t.classList.add(`pass-active`)})})}function Oa(){E=!1,tr=null;let e=document.querySelector(`.player-hand`);e?.classList.remove(`player-hand--dealing`,`is-dealing`,`deal-active`);let t=e?.querySelector(`.player-hand__meta`);t&&(t.textContent=Fi()?`Đang chia bài...`:`Còn ${Ii()} • bấm 1 lá để chọn`);let n=e?.querySelector(`.draft-hand-meta__info em`);n&&(n.textContent=`Nếu không chọn, hết giờ sẽ chọn ngẫu nhiên.`),ea()}function ka(){E=!1,_s=null;let e=document.querySelector(`.player-hand`);e?.classList.remove(`player-hand--dealing`,`is-dealing`,`deal-active`);let t=e?.querySelector(`.player-hand__meta`);t&&(t.textContent=Fi()?`Đang chia bài...`:`Còn ${Ii()} • bấm 1 lá để chọn`);let n=e?.querySelector(`.draft-hand-meta__info em`);n&&(n.textContent=`Bấm để chọn, giữ 0.5s để xem lớn.`),oa(),Mi()}function Aa(){let e=Cn();e&&(T=[...e]),D=!1,R=!1,A=!1,E=!0,Ms=!0,v(`deal`),Y(),ps=Bs(),window.requestAnimationFrame(()=>{document.querySelector(`.player-hand:not(.player-hand--draft)`)?.classList.add(`planning-deal-active`)}),window.setTimeout(()=>{E=!1;let e=document.querySelector(`.player-hand`);e?.classList.remove(`player-hand--dealing`,`is-dealing`,`deal-active`,`planning-deal-active`);let t=e?.querySelector(`.player-hand__meta`);t&&(t.textContent=`Giữ 0.5s để xem lớn`)},1760)}function ja(){$i(),wa(),E=!0,k=null,K(),Rs(),tr=window.setTimeout(()=>{Oa()},xs)}function Ma(){wa(),tr=window.setTimeout(()=>{E=!1,tr=null;let e=document.querySelector(`.player-hand`);e?.classList.remove(`player-hand--dealing`,`is-dealing`,`deal-active`);let t=e?.querySelector(`.player-hand__meta`);t&&(t.textContent=`Giữ 0.5s để xem lớn`),Sa(),!D&&!R&&(wr(),window.setTimeout(()=>{Cr()},250))},1320)}function Na(){Ca(),wa(),kr(),xa(),xr(),un(),S>=4?(!Qn&&Zn>0&&(Yn-=Zn*10,Qn=!0),x+=1,S=0,or=Kn(),sr=qn(),w=ln(Wn),Xn={coin:0,stamina:0},C={coin:0,stamina:0},Zn=0,Qn=!1):S+=1,R=!1,z=null,B=0,V=!1,$n=!1,dr=15,j=null,M=null,P=null,F=null,I=null,lr=null,L=!1}function Pa(e){return e?e.replaySteps.reduce((e,t)=>({coin:e.coin,stamina:e.stamina+(t.eventStaminaDelta??0)}),{coin:0,stamina:0}):{coin:0,stamina:0}}function Fa(e){let t=Pa(e);return Math.abs(Math.min(0,t.stamina))}function Ia(){if(!z||$n)return;let e=Pa(z);Yn+=z.finalVP,C={coin:C.coin+e.coin,stamina:C.stamina+e.stamina},$n=!0}function La(){G(),wo(),xr(),j=null,M=null,P=null,F=null,I=null,L=!1,z=Pr(),B=0,V=!1,R=!0,Nr(),xa(),kr(),pr=window.setInterval(()=>{if(z){if(B>=z.replaySteps.length-1){B=z.replaySteps.length-1,V=!0,Ia(),kr(),K(),Ca(),er=window.setTimeout(()=>{Na()},1800);return}B+=1,Nr(),K()}},850),K()}function Ra(){G(),wo(),xr(),xa(),kr(),j=null,M=null,P=null,F=null,I=null,L=!1,z=Pr(),B=0,V=!1,R=!0,vs=!0,Nr(),pr=window.setInterval(()=>{if(z){if(B>=z.replaySteps.length-1){B=z.replaySteps.length-1,V=!0,kr(),Y();return}B+=1,Nr(),Y()}},850),Y()}function za(){xr(),R=!1,z=null,B=0,V=!1,$n=!1,dr=15,Ca(),wa(),E=!1,kr(),j=null,M=null,P=null,F=null,I=null,L=!1,K(),Sa()}function Ba(){let e=Fr(),t=d.roomState?.phase===`lobby`||d.roomState?.phase===`cinematic`,n=Rn()??(z?Ja():Yn),r=kn();return`
    <section class="score-breakdown score-breakdown--status" title="${r}">
      ...
      ${z?`
          ...
          `:D?`
              <div
                class="score-breakdown__timer ${Li()?`score-breakdown__timer--danger`:``}"
            ...
            `:`
              <div
                class="score-breakdown__timer ${dr<=10?`score-breakdown__timer--danger`:``}"
  ...
  `}function Va(){if(R||z||pn())return``;let e=Rr();return`
  ...
  `}function Ha(){if(!pn())return``;let e=mn(),t=d.playerId;return`
    <section class="final-ranking-panel">
      <div class="final-ranking-panel__header">
        ...
        <p>Hết 5 ngày. BXH sẽ tự đóng sau ${d.roomState?.timer??10}s để qua Phase ${x+1}.</p>
      </div>
      ...
      ${Ua(`travel-export-panel--final`)}

      <div class="final-ranking-panel__footer">
        ${x>=3?`Đã kết thúc Phase 3. Đây là kết quả cuối của game.`:`Đang chuẩn bị chuyển sang Phase ${x+1}...`}
      </div>
    </section>
  ...
  `}function Wa(e){return e>0?`+${e} VP`:e<0?`${e} VP`:`0 VP`}function Ga(){return z?z.replaySteps.slice(0,B+1).reduce((e,t)=>e+t.vpDelta,0):0}function Ka(){return z&&$n?Yn-z.finalVP:Yn}function qa(){return z?Ka()+(V?z.finalVP:Ga()):Yn}function Ja(){return z?V?Yn:Ka():Yn}function Ya(){if(!z)return``;let e=z,t=Ar(),n=Math.max(1,e.replaySteps.length),r=Math.min(B+1,n),i=V?e.finalVP:Ga(),a=B===n-1?460:B===n-2?180:0,o=223+B*366+a,s=e=>e===`storm`?`⛈`:e===`traffic`?`🚦`:e===`distance`?`🧭`:e===`promo`?`🏷`:`✦`,c=e=>e.eventText?e.eventText:e.eventType===`storm`?`Mưa giông`:e.eventType===`traffic`?`Kẹt xe`:e.eventType===`distance`?`Xa tuyến`:e.eventType===`promo`?`Ưu đãi`:``;return`
      ...
      <div class="ticket-scan-overlay__footer">
        ...
        ${V?`
              <div class="ticket-scan-overlay__complete">
                <span>Hoàn tất</span>
                <strong>${Ka()} → ${qa()} VP</strong>
              </div>
            `:``}
      </div>
    </section>
  `}function Xa(e,t){if(!z)return null;let n=z.replaySteps.findIndex(n=>n.rowIndex===e&&n.dayIndex===t);return n<0||n>B?null:z.replaySteps[n]??null}function Za(e,t){if(!z||t!==S)return``;let n=Ar(),r=n?.rowIndex===e&&n?.dayIndex===t,i=z.replaySteps.findIndex(n=>n.rowIndex===e&&n.dayIndex===t),a=i>=0?z.replaySteps[i]:null,o=i>=0&&i<B,s=a?.eventType&&i<=B?`board-cell--event-${a.eventType}`:``;return r?`board-cell--replay-current ${s}`.trim():o?`board-cell--replay-done ${s}`.trim():`board-cell--replay-pending`}var Qa=!1,$a=``;function eo(){if(b()){let e=An();return Math.max(0,e?.coinDebt??0)}return Math.max(0,Zn)}function to(){eo()<=0||(Qa=!0,$a=``,Y())}function no(){Qa=!1,$a=``,Y()}function ro(){if(eo()<=0){no();return}if(b()){ue(),no();return}let e=Rr(),t=Math.min(e.coin,Zn);if(t<=0){$a=`Bạn chưa có xu để trả nợ lúc này.`,Y();return}if(Zn=Math.max(0,Zn-t),C=Object.assign(Object.assign({},C),{coin:C.coin-t}),$a=Zn>0?`Đã trả ${t} xu. Hiện còn nợ ${Zn} xu.`:`Đã trả hết nợ (${t} xu).`,v(`eventPromo`),Zn<=0){no();return}Y()}function ao(){return`
  ...
  `}function oo(){if(!Qa)return``;let e=eo(),t=Rr().coin,n=e*10;return`
    <div
    ...
    >
      ...
      >
          ...
          <div class="effect-token-modal__seal-preview">
            <span class="player-effect-seal player-effect-seal--debt player-effect-seal--preview">
              <span class="player-effect-seal__surface">
                ...
                <span class="player-effect-seal__glyph player-effect-seal__glyph--debt" aria-hidden="true">${ao()}</span>
              </span>
        ...
        <div class="effect-token-modal__body">
          ...
          ${$a?`<div class="effect-token-modal__notice">${$a}</div>`:``}
        </div>
  ...
  `}function so(){let e=[],t=eo();return t>0&&e.push(`
      <button
        type="button"
  ...
  `:`
    ...
    `}function co(){b()||w.length;let e=(b()?Cn():null)?.length??T.length,t=!!(Z||k)&&!ws&&!A&&!Fs(),n=D?`
      <button
        type="button"
    ...
    >
      ...
      <div class="deck-pile-panel__info">
        ...
        <div>
          ...
          <strong>${Un().length}</strong>
        </div>
      </div>
    </section>
  `}function lo(){let e=si(P)??F;return`
      ...
      <div class="arena__main">
        <div class="board-block">
          <div class="days-header">
            ${Re.map((e,t)=>`<div class="day-pill ${t===S?`day-pill--current`:``} ${t<S?`day-pill--done`:``}">NGÀY ${e}</div>`).join(``)}
          </div>
          ...
          <section class="board-grid">
            ${ze.map((e,t)=>`
                  ...
                  ${Re.map((e,n)=>{let r=ci(t,n),i=n===S,a=!D&&!R&&!E&&i&&j!==null&&r===null;return r?`
                        <div
                          class="board-cell board-cell--occupied board-cell--clickable ${Za(t,n)} ${Dr(t,n)?`board-cell--just-placed`:``}"
                      ...
                      `:`
                          <div
                            class="board-cell board-cell--empty ${Za(t,n)} ${R?`board-cell--locked-mode`:``} ${!i&&!R?`board-cell--not-current-day`:``} ${a?`board-cell--placeable`:``}"
                            data-board-drop-cell="true"
                            data-row-index="${t}"
                            data-col-index="${n}"
                            onclick="event.stopPropagation(); handleBoardCellClick(${t}, ${n})"
        ...
        ${R?``:`
              <section
          class="player-hand ${D?`player-hand--draft`:``} ${!D&&E?`player-hand--dealing is-dealing`:``}"
          onclick="${D?``:`clearSelectedHandCard()`}"
        >
          <div class="player-hand__top">
            <div class="player-hand__title">
              <span class="hand-badge">${D?`DRAFT`:`HAND`}</span>
              <h2>
                ${D?`Chọn bài ngày ${Re[S]}`:`Bài ngày ${Re[S]}`}
              </h2>
            </div>

            <div class="player-hand__meta ${D&&Li()?`player-hand__meta--danger`:``}">
              ${D?Fi()?`Đang chia bài...`:`Còn ${nr}s • ${A?`Đang chuyền bài...`:`bấm 1 lá để chọn`}`:E?`Đang chia bài...`:`Giữ 0.5s để xem lớn`}
            </div>
          </div>

          ${D?pi():``}

          <div class="player-hand__cards ${D?`player-hand__cards--draft player-hand__cards--picked player-hand__cards--picked-count-${vi()}`:``}">
            ${D?ki():T.map((e,t)=>di(e,t)).join(``)}
          </div>
        </section>
            `}
      </div>
  ...
  `}function G(){ur!==null&&(window.clearTimeout(ur),ur=null)}var uo=-1,fo=-1;function po(e,t,n){let r=document.querySelector(e);if(!r)return;let i=document.createElement(`div`);i.className=`floating-text floating-text--${n}`,i.textContent=`${t>0?`+`:``}${t}`,r.appendChild(i),r.classList.remove(`resource-pulse`),r.clientWidth,r.classList.add(`resource-pulse`),setTimeout(()=>i.remove(),1200)}function K(){let e=document.querySelector(`.arena`);e&&(e.outerHTML=lo(),Fs()&&window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{Is()})}),requestAnimationFrame(()=>{let e=Rr();uo!==-1&&e.coin!==uo&&po(`.resource-orb--coin .resource-orb__frame`,e.coin-uo,`coin`),fo!==-1&&e.stamina!==fo&&po(`.resource-orb--stamina .resource-orb__frame`,e.stamina-fo,`stamina`),uo=e.coin,fo=e.stamina}))}function mo(e,t,n){if(R||E||n!==S||!Zr(t,n))return;let r=T.findIndex(t=>t.id===e);if(r===-1)return;let i=T[r];if(b()){v(`cardPlace`),ce({cardId:i.id,rowIndex:t,colIndex:n,tag:i.tag,icon:i.icon,vp:i.vp,coin:i.coin,stamina:i.stamina,name:i.name}),j=null,M=null,P=null,F=null,I=null,L=!1;return}let a=Rr(),o=Math.max(0,i.coin-a.coin),s=Math.max(0,i.stamina-a.stamina);v(`cardPlace`),T.splice(r,1),H()[t][n]=i,ti({rowIndex:t,colIndex:n,card:i,coinDebt:o,staminaDebt:s}),ce({cardId:i.id,rowIndex:t,colIndex:n,tag:i.tag,icon:i.icon,vp:i.vp,coin:i.coin,stamina:i.stamina,image:i.image,name:i.name}),Tr(i),j=null,M=null,P=null,F=null,I=null,L=!1,lr={rowIndex:t,colIndex:n},K(),window.setTimeout(()=>{lr?.rowIndex===t&&lr?.colIndex===n&&(lr=null,K())},420)}function ho(e,t){j&&mo(j,e,t)}function go(){if(R||!I)return;let{rowIndex:e,colIndex:t}=I;if(t!==S)return;let n=H()[e]?.[t];if(!(!n||Yr(n)||Xr(n))){if(b()){de({rowIndex:e,colIndex:t}),P=null,F=null,I=null,lr=null,j=null,L=!1;return}for(H()[e][t]=null,ii(e,t,n),T.unshift(n);T.length>5;){let e=T.pop();e&&w.unshift(e)}P=null,F=null,I=null,lr=null,j=null,L=!1,K()}}function _o(e){if(!N||N.isDragging)return;G(),P=null,F=null,I=null,L=!1;let{source:t}=N,n=t.getBoundingClientRect(),r=t.cloneNode(!0);r.classList.add(`hand-card--drag-clone`),r.classList.remove(`hand-card--selected`),r.style.width=`${n.width}px`,r.style.height=`${n.height}px`,r.style.left=`${n.left}px`,r.style.top=`${n.top}px`,r.style.transform=`none`,r.style.pointerEvents=`none`,document.body.appendChild(r),t.classList.add(`hand-card--drag-source-hidden`),N.clone=r,N.offsetX=e.clientX-n.left,N.offsetY=e.clientY-n.top,N.isDragging=!0,M=N.id,j=N.id,vo(e)}function vo(e){N?.clone&&(N.clone.style.left=`${e.clientX-N.offsetX}px`,N.clone.style.top=`${e.clientY-N.offsetY}px`)}function yo(e){return document.elementFromPoint(e.clientX,e.clientY)?.closest(`[data-board-drop-cell='true']`)}function bo(e){return document.elementFromPoint(e.clientX,e.clientY)?.closest(`[data-discard-drop-zone='true']`)}function xo(){document.querySelectorAll(`.deck-pile-panel--discard-hover`).forEach(e=>{e.classList.remove(`deck-pile-panel--discard-hover`),delete e.dataset.discardCoin,delete e.dataset.discardStamina})}function So(){return!D&&!R&&!E}function Co(e){if(!So())return;let t=T.findIndex(t=>t.id===e);if(t===-1)return;let n=T[t];if(v(`returnDeck`),b()){let e=d.roomState,t=d.playerId;if(e&&t){let r=e.self.hand.findIndex(e=>e.id===n.id);r>=0&&e.self.hand.splice(r,1);let i=e.players[t];i&&(i.coin+=n.coin,i.stamina+=n.stamina),T=[...e.self.hand]}le({cardId:n.id,coin:n.coin,stamina:n.stamina,name:n.name}),j=null,M=null,P=null,F=null,I=null,L=!1,Y();return}T.splice(t,1),Xn={coin:Xn.coin+n.coin,stamina:Xn.stamina+n.stamina},j=null,M=null,P=null,F=null,I=null,L=!1,K()}function wo(){var e;Ao(),xo(),N?.source&&N.source.classList.remove(`hand-card--drag-source-hidden`),(e=N?.clone)==null||e.remove(),N=null,M=null,document.querySelectorAll(`.board-cell--placeable`).forEach(e=>e.classList.remove(`board-cell--placeable`))}function To(e){if(!N)return;let t=e.clientX-N.startX,n=e.clientY-N.startY,r=Math.hypot(t,n);if(!N.isDragging&&r>=8&&(G(),_o(e)),!N?.isDragging)return;e.preventDefault(),vo(e),Ao(),xo();let i=bo(e);if(i&&So()){let e=si(M);i.classList.add(`deck-pile-panel--discard-hover`),i.dataset.discardCoin=String(e?.coin??0),i.dataset.discardStamina=String(e?.stamina??0);return}let a=yo(e);if(!a)return;let o=Number(a.dataset.rowIndex),s=Number(a.dataset.colIndex),c=si(M);Number.isInteger(o)&&Number.isInteger(s)&&Zr(o,s)&&c?a.classList.add(`board-cell--drag-hover`):a.classList.add(`board-cell--drag-invalid`)}function Eo(e){document.removeEventListener(`pointermove`,To),document.removeEventListener(`pointerup`,Eo),document.removeEventListener(`pointercancel`,Do);let t=N,n=t?.isDragging===!0;if(G(),t){if(n){let n=yo(e),r=bo(e),i=Number(n?.dataset.rowIndex),a=Number(n?.dataset.colIndex),o=t.id;wo(),L=!0,window.setTimeout(()=>{L=!1},0);let s=si(o);if(r&&s&&So()){Co(o);return}if(n&&Number.isInteger(i)&&Number.isInteger(a)&&Zr(i,a)&&s){mo(o,i,a);return}n&&Number.isInteger(i)&&Number.isInteger(a)?Oo(i,a):Oo(),j=null,K();return}wo()}}function Do(){document.removeEventListener(`pointermove`,To),document.removeEventListener(`pointerup`,Eo),document.removeEventListener(`pointercancel`,Do),G(),wo(),j=null,L=!1,K()}function Oo(e,t){v(`reject`);let n=e!==void 0&&t!==void 0?document.querySelector(`[data-row-index="${e}"][data-col-index="${t}"]`):document.querySelector(`.arena`);n?.classList.add(`resource-rejected-feedback`),window.setTimeout(()=>{n?.classList.remove(`resource-rejected-feedback`)},380)}function ko(e){return e.dataTransfer?.getData(`text/plain`)||M}function Ao(){document.querySelectorAll(`.board-cell--drag-hover, .board-cell--drag-invalid`).forEach(e=>{e.classList.remove(`board-cell--drag-hover`),e.classList.remove(`board-cell--drag-invalid`)})}window.startDragHandCard=(e,t)=>{var n;G(),M=t,j=t,P=null,F=null,I=null,L=!0,(n=e.dataTransfer)==null||n.setData(`text/plain`,t),e.dataTransfer&&(e.dataTransfer.effectAllowed=`move`)},window.endDragHandCard=()=>{G(),Ao(),M=null,window.setTimeout(()=>{L=!1},0)},window.handleBoardCellDragOver=(e,t,n)=>{!M||H()[t][n]!==null||(e.dataTransfer&&(e.dataTransfer.dropEffect=`move`),e.currentTarget?.classList.add(`board-cell--drag-hover`))},window.handleBoardCellDragLeave=e=>{e.currentTarget?.classList.remove(`board-cell--drag-hover`)},window.dropHandCardOnBoard=(e,t,n)=>{G(),Ao();let r=ko(e);if(M=null,!r)return;let i=si(r);if(!Zr(t,n)||!i){Oo(t,n);return}mo(r,t,n)},window.startHandPointerDrag=(e,t)=>{if(E||R||e.button!==0||!si(t))return;wo();let n=e.currentTarget;n&&(N={id:t,source:n,clone:null,startX:e.clientX,startY:e.clientY,offsetX:0,offsetY:0,isDragging:!1},document.addEventListener(`pointermove`,To),document.addEventListener(`pointerup`,Eo),document.addEventListener(`pointercancel`,Do),document.querySelectorAll(`.board-cell`).forEach(e=>{let t=parseInt(e.getAttribute(`data-row-index`)||`-1`),n=parseInt(e.getAttribute(`data-col-index`)||`-1`);t>=0&&n>=0&&Zr(t,n)&&e.classList.add(`board-cell--placeable`)}))},window.openDebtTokenModal=()=>{to()},window.closeDebtTokenModal=()=>{no()},window.payCoinDebtFromModal=()=>{ro()},window.selectDraftCard=ga,window.confirmDraftPick=_a,globalThis.confirmDraftPick=_a,window.startHoldHandCard=e=>{A||E||(G(),ur=window.setTimeout(()=>{P=e,F=null,I=null,L=!0,G(),K()},500))},window.cancelHoldHandCard=()=>{G()},window.clearSelectedHandCard=()=>{G(),j!==null&&(j=null,K())},window.handleBoardCellClick=(e,t)=>{G();let n=ci(e,t);if(n){if(Yr(n)){if(!D&&!E&&t===S&&j){ho(e,t);return}ri(e,t,n);return}wo(),P=null,F=n,I={rowIndex:e,colIndex:t},j=null,L=!1,K();return}!D&&!E&&t===S&&ho(e,t)},window.focusBoardCard=(e,t)=>{let n=ci(e,t);n&&(P=null,F=n,I={rowIndex:e,colIndex:t},j=null,L=!1,K())},window.runSimulation=()=>{La()},window.resetSimulation=()=>{za()},window.returnFocusedBoardCardToHand=()=>{go()},window.closeFocusedHandCard=()=>{G(),P=null,F=null,I=null,M=null,L=!1,K()};function jo(e){let t={p1:1,p2:3,p3:3,p4:3};return[...nn,...rn].find(t=>t.id===e)??{id:e,rank:t[e],name:e.toUpperCase(),score:0,coin:3,stamina:2,usedSlots:0}}function Mo(){let e=d.playerId;return!e||!d.roomState?[]:Gn.filter(t=>t===e?!1:d.roomState?.players[t]?.isConnected===!0).map(e=>{let t=jo(e),n=d.roomState?.players[e];return Object.assign(Object.assign({},t),{name:n?.name??t.name,score:n?.score??t.score,coin:n?.coin??t.coin,stamina:n?.stamina??t.stamina,usedSlots:n?.usedSlots??t.usedSlots,active:!1})})}function No(){return b()?Mo().slice(0,2):Lr()}function Po(){return b()?Mo().slice(2):[rn[0]]}function Fo(){let e=d.roomState;return e?Gn.map(t=>{let n=e.players[t];return{playerId:t,name:n?.name??t.toUpperCase(),score:n?.score??0,coin:n?.coin??3,stamina:n?.stamina??2,usedSlots:n?.usedSlots??0,isConnected:n?.isConnected??!1,hasJoined:n?.hasJoined??!1}}).filter(e=>e.hasJoined||e.isConnected).sort((e,t)=>t.score===e.score?t.usedSlots===e.usedSlots?e.playerId.localeCompare(t.playerId):t.usedSlots-e.usedSlots:t.score-e.score):[]}function Io(){if(!mr||!b())return``;let e=Fo(),t=d.playerId;return`
  ...
  `}var Lo=`assets/sounds/in-game-background.mp3`,Ro=`travelDeck.inGameMusicMuted`,zo=`travelDeck.inGameMusicVolume`,Bo=.5,Vo=null,Ho=localStorage.getItem(Ro),Uo=Number(localStorage.getItem(zo)),q=Ho===`true`,J=Uo;(!Number.isFinite(J)||J<=0)&&(J=Bo,localStorage.setItem(zo,String(J)),Ho===null&&localStorage.setItem(Ro,`false`));function Wo(e){return Math.max(0,Math.min(1,e))}function Go(){if(!Vo){let e=new Audio(Lo);e.loop=!0,e.preload=`auto`,e.volume=Wo(J),e.muted=q,Vo=e}return Vo}function Ko(){return b()&&d.roomState?.phase!==`lobby`}function qo(){ve(),document.querySelectorAll(`audio, video`).forEach(e=>{if(e===Vo)return;let t=e;try{t.pause(),t.muted=!0,(t.id===`hub-hero-video`||t.classList.contains(`hub-hero__video`))&&(t.currentTime=0)}catch{}})}function Jo(){let e=Go();if(e.volume=Wo(J),e.muted=q,!Ko()){e.pause();return}if(qo(),q||J<=0){e.pause();return}e.play().catch(()=>{})}function Yo(){let e=document.querySelector(`[data-in-game-music-toggle]`),t=document.querySelector(`[data-in-game-music-value]`),n=document.querySelector(`[data-in-game-music-slider]`);e&&(e.classList.toggle(`is-muted`,q||J<=0),e.textContent=q||J<=0?`🔇`:`🔊`,e.title=q?`Bật nhạc nền`:`Tắt nhạc nền`),t&&(t.textContent=`${Math.round(Wo(J)*100)}%`),n&&(n.value=String(Math.round(Wo(J)*100)))}function Xo(){q=!q,localStorage.setItem(Ro,String(q)),!q&&J<=0&&(J=Bo,localStorage.setItem(zo,String(J))),Jo(),Yo()}function Zo(e){let t=typeof e==`number`?e:Number(e);Number.isFinite(t)&&(J=Wo(t>1?t/100:t),q=J<=0,localStorage.setItem(zo,String(J)),localStorage.setItem(Ro,String(q)),Jo(),Yo())}function Qo(){let e=Math.round(Wo(J)*100),t=q||e<=0;return`
  ...
  `}function $o(){let e=()=>{Jo()};document.addEventListener(`pointerdown`,e,{passive:!0}),document.addEventListener(`keydown`,e)}window.toggleInGameBackgroundMusic=Xo,window.setInGameBackgroundMusicVolume=Zo;function es(){return!b()||d.roomState?.phase===`lobby`?``:`
  ...
  `}function ts(e){return Array.from({length:Math.max(0,e)},()=>`<section class="side-player side-player--empty-spacer" aria-hidden="true"></section>`).join(``)}var ns=`dashboard`,rs=null;function is(e){if(e!==`dashboard`&&qo(),!document.startViewTransition){ns=e,Y();return}document.startViewTransition(()=>{ns=e,Y()})}var as=!1;window.gotoMapSelection=()=>{if(as)return;if(!n.user){window.focusHubAuthPanel(),Ws(`Đăng nhập hoặc đăng ký để bắt đầu hành trình.`);return}as=!0;let e=document.createElement(`video`);e.src=`./assets/chuyencanh.mp4`,e.muted=!0,e.playsInline=!0,e.style.cssText=[`position:fixed`,`inset:0`,`width:100%`,`height:100%`,`object-fit:cover`,`z-index:9999`,`pointer-events:auto`,`opacity:0`,`transition:opacity 0.4s ease`].join(`;`),document.body.appendChild(e),e.playbackRate=1.75,e.play().catch(()=>{e.muted=!0,e.playbackRate=1.75,e.play()}),requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.style.opacity=`1`})});let t=!1;e.addEventListener(`timeupdate`,()=>{!t&&e.currentTime>=3.5&&(t=!0,as=!1,rs=e,document.body.removeChild(e),e.style.cssText=[`position:absolute`,`inset:0`,`width:100%`,`height:100%`,`object-fit:cover`,`z-index:0`,`pointer-events:none`,`opacity:1`].join(`;`),ns=`map_selection`,Y(),requestAnimationFrame(()=>{document.querySelectorAll(`.map-card-col`).forEach((e,t)=>{setTimeout(()=>e.classList.add(`map-card-col--slide-in`),200+t*140)})})),e.duration&&e.currentTime>=e.duration-.5&&(e.currentTime=5)})},window.gotoOnlineLobby=()=>{if(!n.user){window.focusHubAuthPanel(),Ws(`Đăng nhập hoặc đăng ký để bắt đầu hành trình.`);return}is(`lobby`)},window.gotoDashboard=()=>{rs&&=(rs.pause(),rs.remove(),null),is(`dashboard`)},window.switchHubAuthTab=e=>{document.querySelectorAll(`[data-hub-auth-tab]`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.hubAuthTab===e)}),document.querySelectorAll(`[data-hub-auth-panel]`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.hubAuthPanel===e)})},window.focusHubAuthPanel=()=>{let e=document.getElementById(`hub-auth`);if(!e){ns=`dashboard`,Y(),window.requestAnimationFrame(()=>{window.focusHubAuthPanel()});return}e.scrollIntoView({behavior:`smooth`,block:`start`}),e.classList.remove(`hub-auth--pulse`),window.requestAnimationFrame(()=>{e.classList.add(`hub-auth--pulse`)}),e.querySelector(`input`)?.focus()},window.startOfflineGame=()=>{alert(`Chế độ chơi offline (Bot) đang được phát triển!`)};function os(){return`<div class="saigon-collage-bg" aria-hidden="true"></div>`}var ss=null,cs=!1;function ls(){console.log(`TRIGGERING CINEMATIC TRANSITION!`),cs=!0;let e=document.createElement(`div`);e.id=`cinematic-blocker`,e.style.cssText=`position:fixed;inset:0;z-index:99999999;cursor:wait;`,e.addEventListener(`mousedown`,e=>{e.preventDefault(),e.stopPropagation()}),e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation()}),e.addEventListener(`touchstart`,e=>{e.preventDefault(),e.stopPropagation()},{passive:!1}),document.body.appendChild(e);let t=document.querySelector(`.online-lobby-card`);t&&t.classList.add(`is-exiting`);let n=document.getElementById(`cinematic-transition-video`),r=document.getElementById(`white-flash-overlay`);if(!n||!r){console.warn(`Missing video or overlay for cinematic transition.`),cs=!1,Y();return}setTimeout(()=>{n.style.display=`block`,n.style.pointerEvents=`none`,n.currentTime=0,n.play().catch(e=>{console.warn(`Video play failed with sound, attempting muted.`,e),n.muted=!0,n.play().catch(e=>{console.error(`Video play failed completely.`,e)})}),n.onpause=()=>{cs&&(console.warn(`Video paused unexpectedly, resuming...`),n.play().catch(e=>console.error(e)))};let e=()=>{if(!cs)return;cs=!1,r.style.display=`block`,r.style.opacity=`1`,n.style.display=`none`,n.ontimeupdate=null;let e=document.getElementById(`cinematic-blocker`);e&&e.remove(),Y();let t=document.querySelector(`.game-shell`);t&&t.classList.add(`is-zooming-in`),setTimeout(()=>{r.style.opacity=`0`,setTimeout(()=>{r.style.display=`none`,t&&t.classList.remove(`is-zooming-in`)},1500)},50)};n.onended=e,n.ontimeupdate=()=>{n.duration&&n.currentTime>=n.duration-.2&&e()},setTimeout(()=>{cs&&(console.warn(`Cinematic transition video timeout fallback.`),e())},2e4)},400)}function us(){let e=document.querySelector(`.game-shell`);e&&delete e.dataset.saigonHover}function ds(){if(!n.isReady)return we(!0);if(!b())return!n.user||ns===`dashboard`?(ns=`dashboard`,we()):ns===`map_selection`?pe():Nn();if(d.roomState?.phase===`lobby`)return Pn();let e=No(),t=Po();return`
  ...
  `}window.rerenderGameShell=Y;function fs(){!b()||d.roomState?.phase===`lobby`?$t.style.setProperty(`background`,`url('./assets/backgrounds/lobby-background.jpg') center/cover no-repeat #0c0b11`,`important`):$t.style.removeProperty(`background`)}function Y(){if(qo(),$t.innerHTML=ds(),fs(),us(),Jo(),ye(),ns===`map_selection`&&rs){let e=document.querySelector(`.map-selection-screen`);e&&e.firstChild&&e.insertBefore(rs,e.firstChild)}Fs()&&window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{Is()})})}var ps=``,ms=null,hs=0,gs=``,_s=null,vs=!1,X=null,ys=null,bs=null,xs=7450,Ss=!1,Cs=0,ws=!1,Z=null,Q=null,Ts=0,Es=750,Ds=1500,Os=.84,ks=!1,As=!1,$=!1,js=null,Ms=!1,Ns=null,Ps=0;function Fs(){return Ss||E||Date.now()<Cs}function Is(){let e=document.querySelector(`.draft-center-overlay`);if(!e)return!1;e.classList.remove(`draft-center-overlay--dealing`);let t=e.querySelectorAll(`.draft-center-card-wrapper`);return t.forEach(e=>{let t=e;t.classList.remove(`draft-center-card-wrapper--flown-to-hand`),t.style.animation=`none`}),e.offsetWidth,t.forEach(e=>{e.style.removeProperty(`animation`)}),e.classList.add(`draft-center-overlay--dealing`),!0}function Ls(){var e;Ps+=1,Ns!==null&&(window.clearTimeout(Ns),Ns=null),Ss=!1,(e=document.querySelector(`.draft-center-overlay`))==null||e.classList.remove(`draft-center-overlay--dealing`)}function Rs(e=xs){Ns!==null&&(window.clearTimeout(Ns),Ns=null);let t=++Ps;Ss=!0,Cs=Date.now()+e,v(`deal`);let n=()=>{t===Ps&&Is()};window.requestAnimationFrame(()=>{window.requestAnimationFrame(n)}),Ns=window.setTimeout(()=>{var e;t===Ps&&(Ns=null,Ss=!1,(e=document.querySelector(`.draft-center-overlay`))==null||e.classList.remove(`draft-center-overlay--dealing`))},e)}function zs(){_s!==null&&(window.clearTimeout(_s),_s=null),js!==null&&(window.clearTimeout(js),js=null),Ls()}function Bs(){let e=d.roomState;if(!e)return`offline`;let t=e.self,n=Gn.map(t=>{let n=e.players[t],r=n.board.map(e=>e.map(e=>e?`${e.cardId}:${e.tag}:${e.icon}:${e.vp}`:`-`).join(`,`)).join(`|`);return[t,n.name,n.score,n.coin,n.stamina,n.usedSlots,n.isConnected?`1`:`0`,n.isReady?`1`:`0`,r].join(`~`)}).join(`||`);return[e.phase,e.phaseNumber??1,e.dayIndex,e.draftRound,t.draftPool.map(e=>e.id).join(`,`),t.pickedDraftCards.map(e=>e.id).join(`,`),t.hand.map(e=>e.id).join(`,`),n].join(`##`)}function Vs(){let e=d.roomState,t=document.querySelector(`.score-breakdown__timer`),n=t?.querySelector(`strong`);if(!(!e||!t||!n)){if(e.phase===`draft`){let r=e.draftTimerHold??0,i=Ss||E||A||r>0||Date.now()<Cs;n.textContent=i?`Chia bài`:`${e.timer}s`,t.classList.toggle(`score-breakdown__timer--danger`,!i&&e.timer<=3);return}if(e.phase===`planning`){n.textContent=ba(e.timer),t.classList.toggle(`score-breakdown__timer--danger`,e.timer<=10);return}e.phase===`gameover`&&(n.textContent=`${e.timer}s`,t.classList.toggle(`score-breakdown__timer--danger`,e.timer<=3))}}function Hs(){let e=Bs(),t=d.roomState?.phase??null;if(e!==ps){if(console.log(`Signature changed:`,ps,`=>`,e),ps=e,ss===`lobby`&&t===`cinematic`){ss=t,ls();return}ss=t;let n=(Fs()||ws)&&!ks&&!As,r=bn()&&document.querySelector(`.draft-center-overlay--passing.pass-active`);cs||(n?(oa(),Vs()):r&&!As&&!ks?Vs():Y()),ks&&(ks=!1,Rs()),As&&(As=!1,$?Da():Ea());return}Vs()}Y(),ps=Bs(),ss=d.roomState?.phase??null;function Us(){let e=0,t=0,n=null,r=null,i=!1,a=!1;function o(){G(),n=null,r=null,i=!1}document.addEventListener(`pointerdown`,o=>{let s=o.target;if(!s)return;let c=s.closest(`[data-draft-card-id]`),l=s.closest(`[data-hand-card-id]`),u=null,d=null;D&&c?(u=c.dataset.draftCardId??null,d=`draft`):!D&&!R&&l&&(u=l.dataset.handCardId??null,d=`hand`),!(!u||!d)&&(n=u,r=d,i=!1,e=o.clientX,t=o.clientY,G(),d===`draft`&&!A&&(a=!0,ga(u)),ur=window.setTimeout(()=>{n&&(i=!0,P=n,F=null,I=null,L=!0,Y())},500))},!0),document.addEventListener(`pointermove`,r=>{!n||ur===null||Math.hypot(r.clientX-e,r.clientY-t)>8&&o()},!0),document.addEventListener(`pointerup`,a=>{let s=n,c=r,l=i,u=Math.hypot(a.clientX-e,a.clientY-t);o(),c===`draft`&&s&&!l&&u<=8&&D&&(a.preventDefault(),a.stopPropagation())},!0),document.addEventListener(`pointercancel`,()=>{o()},!0),document.addEventListener(`click`,e=>{let t=e.target;if(!t)return;let n=t.closest(`[data-draft-card-id]`);if(n&&D){if(e.preventDefault(),e.stopPropagation(),a){a=!1;return}let t=n.dataset.draftCardId;t&&ga(t);return}let r=t.closest(`[data-hand-card-id]`);if(r&&!D){e.preventDefault(),e.stopPropagation();let t=r.dataset.handCardId;t&&va(t)}},!0)}Us(),Gs(),Pt(),$o(),h(()=>{Hn(),Hs()}),window.createOnlineRoom=(e=`An`)=>{g(e)},window.joinOnlineRoom=(e,t=`Player`)=>{te(e,t)},window.startOnlineGame=()=>{ae()},window.selectDraftCard=ga,window.selectHandCard=va,window.clearSelectedHandCard=ya;function Ws(e,t=!1){let n=document.querySelector(`#hub-auth-status`)??document.querySelector(`#auth-status`);n&&(n.textContent=e,n.classList.toggle(`hub-auth__status--error`,t),n.classList.toggle(`hub-auth__status--success`,!!e&&!t),n.classList.toggle(`auth-card__status--error`,t),n.classList.toggle(`auth-card__status--success`,!!e&&!t))}function Gs(){document.addEventListener(`submit`,e=>{let t=e.target;if(t){if(t.id===`auth-login-form`||t.id===`hub-auth-login-form`){e.preventDefault(),e.stopPropagation(),window.loginFromAuthScreen();return}(t.id===`auth-register-form`||t.id===`hub-auth-register-form`)&&(e.preventDefault(),e.stopPropagation(),window.registerFromAuthScreen())}},!0)}window.loginFromAuthScreen=()=>Qt(void 0,void 0,void 0,function*(){let e=document.querySelector(`#hub-auth-login-username`)??document.querySelector(`#auth-login-username`),t=document.querySelector(`#hub-auth-login-password`)??document.querySelector(`#auth-login-password`);Ws(`Đang đăng nhập...`);try{yield o({username:e?.value.trim()??``,password:t?.value??``}),Ws(`Đăng nhập thành công.`),Y()}catch(e){let t=e instanceof Error?e.message:`Đăng nhập thất bại.`;Ws(t,!0),alert(t)}}),window.registerFromAuthScreen=()=>Qt(void 0,void 0,void 0,function*(){let e=document.querySelector(`#hub-auth-register-display-name`)??document.querySelector(`#auth-register-display-name`),t=document.querySelector(`#hub-auth-register-username`)??document.querySelector(`#auth-register-username`),n=document.querySelector(`#hub-auth-register-password`)??document.querySelector(`#auth-register-password`);Ws(`Đang tạo tài khoản...`);try{yield s({displayName:e?.value.trim()||void 0,username:t?.value.trim()??``,password:n?.value??``}),Ws(`Tạo tài khoản thành công.`),Y()}catch(e){let t=e instanceof Error?e.message:`Đăng ký thất bại.`;Ws(t,!0),alert(t)}}),window.logoutFromAuthScreen=()=>{c(),d.roomId=null,d.playerId=null,d.roomState=null,ns=`dashboard`,Y()},window.createRoomFromLobby=()=>{qo(),g(document.querySelector(`#lobby-create-name`)?.value.trim()||n.user?.displayName||n.user?.username||`An`)},window.joinRoomFromLobby=()=>{qo();let e=document.querySelector(`#lobby-join-name`),t=document.querySelector(`#lobby-room-code`),n=e?.value.trim()||`Player`,r=t?.value.trim().toUpperCase();if(!r){alert(`Nhập room code trước.`);return}te(r,n)},window.reconnectSavedRoomFromLobby=()=>{qo();let e=m();e&&ne(e.roomId,e.playerId,e.playerName)},window.clearSavedRoomFromLobby=()=>{ee(),Y()},window.toggleReadyFromLobby=()=>{let e=An();if(!e||!d.playerId||!d.roomState)return;let t=!e.isReady;d.roomState.players[d.playerId].isReady=t,Y(),re(t)},window.leaveRoomFromLobby=()=>{ie(),Y()},window.copyRoomCodeFromLobby=()=>Qt(void 0,void 0,void 0,function*(){let e=d.roomId;if(e)try{yield navigator.clipboard.writeText(e),alert(`Đã copy room code: ${e}`)}catch{prompt(`Copy room code:`,e)}}),window.openMidGameRanking=()=>{mr=!0,Y()},window.closeMidGameRanking=()=>{mr=!1,Y()},window.downloadTravelCertificateHtml=()=>{qt()},window.downloadTravelTimelineTxt=()=>{Xt(`txt`)},window.downloadTravelTimelineJson=()=>{Xt(`json`)},window.copyTravelTimeline=()=>{Zt()},window.debugOnlineBoards=()=>{let e=d.roomState;if(!e)return console.log(`No online room state.`),null;let t={},n=[`p1`,`p2`,`p3`,`p4`];for(let r of n){let n=e.players[r],i=[];for(let e=0;e<n.board.length;e+=1){let t=n.board[e];for(let n=0;n<t.length;n+=1){let r=t[n];r&&i.push({rowIndex:e,colIndex:n,cardId:r.cardId,tag:r.tag,icon:r.icon,vp:r.vp})}}t[r]={name:n.name,connected:n.isConnected,usedSlots:n.usedSlots,filledCells:i}}return console.table(n.map(e=>({playerId:e,name:t[e].name,connected:t[e].connected,usedSlots:t[e].usedSlots,filled:t[e].filledCells.length}))),console.log(t),t},window.onlineClientState=d,window.debugOnlineScores=()=>{let e=d.roomState;if(!e)return console.log(`No online room state.`),null;let t=Gn.map(t=>{let n=e.players[t];return{playerId:t,name:n.name,score:n.score,coin:n.coin,stamina:n.stamina,usedSlots:n.usedSlots,connected:n.isConnected,ready:n.isReady,joined:n.hasJoined}});return console.table(t),t},globalThis.createOnlineRoom=window.createOnlineRoom,globalThis.joinOnlineRoom=window.joinOnlineRoom,globalThis.startOnlineGame=window.startOnlineGame,globalThis.selectDraftCard=window.selectDraftCard,globalThis.selectHandCard=window.selectHandCard,globalThis.clearSelectedHandCard=window.clearSelectedHandCard,globalThis.loginFromAuthScreen=window.loginFromAuthScreen,globalThis.registerFromAuthScreen=window.registerFromAuthScreen,globalThis.logoutFromAuthScreen=window.logoutFromAuthScreen,globalThis.forceLogoutAuth=window.logoutFromAuthScreen,globalThis.createRoomFromLobby=window.createRoomFromLobby,globalThis.joinRoomFromLobby=window.joinRoomFromLobby,globalThis.reconnectSavedRoomFromLobby=window.reconnectSavedRoomFromLobby,globalThis.clearSavedRoomFromLobby=window.clearSavedRoomFromLobby,globalThis.toggleReadyFromLobby=window.toggleReadyFromLobby,globalThis.copyRoomCodeFromLobby=window.copyRoomCodeFromLobby,globalThis.leaveRoomFromLobby=window.leaveRoomFromLobby,globalThis.onlineClientState=d,globalThis.openMidGameRanking=window.openMidGameRanking,globalThis.closeMidGameRanking=window.closeMidGameRanking,globalThis.downloadTravelCertificateHtml=window.downloadTravelCertificateHtml,globalThis.toggleInGameBackgroundMusic=window.toggleInGameBackgroundMusic,globalThis.setInGameBackgroundMusicVolume=window.setInGameBackgroundMusicVolume,globalThis.downloadTravelTimelineTxt=window.downloadTravelTimelineTxt,globalThis.downloadTravelTimelineJson=window.downloadTravelTimelineJson,globalThis.copyTravelTimeline=window.copyTravelTimeline,globalThis.playGameSound=v,globalThis.debugOnlineBoards=window.debugOnlineBoards,globalThis.selectDraftCard=window.selectDraftCard,Y();